...
const statusFlow = ["Accepted", "On The Way", "In Progress", "Completed"];
    ...
    const loadWorkspace = async () => {
      try {
        ...
        const [servicesResponse, bookingsResponse] = await Promise.all([
          fetch(`${API}/services/provider/${providerId}`),
          fetch(`${API}/bookings/provider/${providerId}`),
        ]);
        ...
        if (!bookingsResponse.ok) {
          throw new Error(
            bookingsData.message || "Unable to load bookings."
          );
        }
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        try {
          ...
          if (!response.ok) {
            throw new Error(
              data.message || "Unable to save location."
            );
          }

          /*
            Keep the existing provider data and only update
            the location. This prevents id from being lost.
          */
          const updatedProvider = {
            ...provider,
            ...data.provider,
            id: provider.id || data.provider._id,
          ...
          setError(error.message || "Unable to update location.");
        } finally {
          setActionLoading("");
        }
      },
      ...
      <section className="workspace-hero">
        <div className="hero-content">
          ...
          <div>
            ...
            <p>
              Manage your services, requests and active jobs from one place.
            </p>
              ...
              <section className="workspace-section fade-up">
                ...
                <div className="section-heading">
                  <div>
                    ...
                    <p>
                      Keep track of requests, services and ongoing work.
                    </p>
                  </div>
                </div>
                          ...
                          <div className="saved-location">
                            <span>
                              ...
                              {provider.location.latitude.toFixed
                                ? provider.location.latitude.toFixed(5)
                            ...
                            <span>
                              ...
                              {provider.location.longitude.toFixed
                                ? provider.location.longitude.toFixed(5)
